...
[CustomPropertyDrawer(typeof(InterfaceAttributeWrapper<>))]
[CustomPropertyDrawer(typeof(InterfaceAttributeWrapper<,>))]
public class InterfaceReferenceDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        InterfaceDrawerUtil.OnGUI(position, underlyingProperty, label, args);
    }
    ...
    static InterfaceArgs GetArguments(FieldInfo fieldInfo)
    {
        ...
        bool TryGetTypesFromInterfaceReference(Type type, out Type objType, out Type intfType)
        {
            ...
            if (genericType == typeof(InterfaceAttributeWrapper<>)) type = type.BaseType;

            if (type?.GetGenericTypeDefinition() == typeof(InterfaceAttributeWrapper<,>))
            {
